...
abstract class PlugintpyProduct extends BasetpyProduct
{
   ...
   * 
   * @see plugins/timpanyPlugin/lib/model/tpyProductInterface::getUid()
   */
  public function getUid()
  {
    return 'tpyProduct_' . $this->getSlug();
  }
  
  /**
   * set product record for extending product types
   * @param tpyProduct $basic_product
   */  
  public function setDoctrineRecord(tpyProduct $basic_product)
  {
  ...
  {
    return new tpyOrderItem($this->getData());
  }
